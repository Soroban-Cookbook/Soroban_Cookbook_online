 ...
 *
 * Avoid requiring a `<main>` landmark — search-local uses theme-layout-main
 * without role=main (same as smoke.spec.ts / search.spec.ts).
 *
...
const SEARCH_INPUT = 'input[name="q"], input[type="search"]';
const SEARCH_RESULTS = '.container.margin-vert--lg article';
